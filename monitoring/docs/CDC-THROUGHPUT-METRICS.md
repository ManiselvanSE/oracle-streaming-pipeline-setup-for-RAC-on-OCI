...
| Issue | Cause | Fix |
|-------|-------|-----|
| No data for connector metrics | JMX not enabled on Connect | Use `docker-compose.monitoring.yml` |
| No data for topic metrics | JMX not enabled on Kafka | Use `docker-compose.monitoring.yml` |
