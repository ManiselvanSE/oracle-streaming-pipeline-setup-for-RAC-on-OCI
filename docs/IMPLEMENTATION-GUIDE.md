...
| Topic offsets | `docker exec kafka2 kafka-run-class kafka.tools.GetOffsetShell --broker-list kafka1:29092,kafka2:29092,kafka3:29092 --topic racdb.ORDERMGMT.MTX_TRANSACTION_ITEMS` |
...
```json
{
  ...
  "config": {
    ...
    "topic.prefix": "racdb",
    "table.include.list": "ORDERMGMT\\.(REGIONS|COUNTRIES|LOCATIONS|WAREHOUSES|EMPLOYEES|PRODUCT_CATEGORIES|PRODUCTS|CUSTOMERS|CONTACTS|ORDERS|ORDER_ITEMS|INVENTORIES|NOTES|MTX_TRANSACTION_ITEMS)",
